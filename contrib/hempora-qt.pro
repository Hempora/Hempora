...
RESOURCES += src/qt/hempora.qrc src/qt/hempora_locale.qrc

TRANSLATIONS += src/qt/locale/hempora_bg.ts \
                src/qt/locale/hempora_de.ts \
                src/qt/locale/hempora_en.ts \
                src/qt/locale/hempora_es.ts \
                src/qt/locale/hempora_fi.ts \
                src/qt/locale/hempora_fr.ts \
                src/qt/locale/hempora_it.ts \
                src/qt/locale/hempora_ja.ts \
                src/qt/locale/hempora_pl.ts \
                src/qt/locale/hempora_pt.ts \
                src/qt/locale/hempora_ru.ts \
                src/qt/locale/hempora_sk.ts \
                src/qt/locale/hempora_sv.ts \
                src/qt/locale/hempora_vi.ts \
                src/qt/locale/hempora_zh_CN.ts \
                src/qt/locale/hempora_zh_TW.ts
