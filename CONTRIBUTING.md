Contributing to Hempora Core
============================

The Hempora Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Hempora Core project, and is not to be
confused with overall Hempora Network Protocol consensus changes.

Whether a pull request is merged into Hempora Core rests with the project merge
...
Patches that change Hempora consensus rules are considerably more involved than
...
Where a patch set proposes to change the Hempora consensus, it must have been
...
The project leader is the release manager for each Hempora Core release.
