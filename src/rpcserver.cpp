...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Hempora server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Hempora features */
        {"hempora", "masternode", &masternode, true, true, false},
        {"hempora", "listmasternodes", &listmasternodes, true, true, false},
        {"hempora", "getmasternodecount", &getmasternodecount, true, true, false},
        {"hempora", "masternodeconnect", &masternodeconnect, true, true, false},
        {"hempora", "masternodecurrent", &masternodecurrent, true, true, false},
        {"hempora", "masternodedebug", &masternodedebug, true, true, false},
        {"hempora", "startmasternode", &startmasternode, true, true, false},
        {"hempora", "createmasternodekey", &createmasternodekey, true, true, false},
        {"hempora", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"hempora", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"hempora", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"hempora", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"hempora", "getmasternodescores", &getmasternodescores, true, true, false},
        {"hempora", "mnbudget", &mnbudget, true, true, false},
        {"hempora", "preparebudget", &preparebudget, true, true, false},
        {"hempora", "submitbudget", &submitbudget, true, true, false},
        {"hempora", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"hempora", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"hempora", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"hempora", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"hempora", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"hempora", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"hempora", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"hempora", "checkbudgets", &checkbudgets, true, true, false},
        {"hempora", "mnsync", &mnsync, true, true, false},
        {"hempora", "spork", &spork, true, true, false},
        {"hempora", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"hempora", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use hemporad, or the -server option to hempora-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> hempora-cli " + methodname + " " + args + "\n";
}
