                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Hempora Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Hempora address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and hempora: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Hempora Core"), this);
    aboutAction->setStatusTip(tr("Show information about Hempora Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Hempora"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Hempora addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Hempora addresses"));
    ...
    openAction->setStatusTip(tr("Open a Hempora: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Hempora Core help message to get a list with possible Hempora command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Hempora Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Hempora network", "", count));
}
...
{
    QString strTitle = tr("Hempora Core"); // default title
...
/** Creates context menu, its actions, and hemporas up all the relevant signals for mouse events. */
