...
/** Utility functions used by the Hempora Qt UI.
 */
namespace GUIUtil
{
...
// Render Hempora addresses in monospace font
...
// Parse "hempora:" URI into recipient object, return true on successful parsing
