...
public:
    ...
    void setZHemporaControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzHEMP_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzHEMP_clicked();
    void on_pushButtonZHemporaControl_clicked();
