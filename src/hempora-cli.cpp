...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Hempora Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  hempora-cli [options] <command> [params]  " + _("Send command to Hempora Core") + "\n" +
                        "  hempora-cli [options] help                " + _("List commands") + "\n" +
                        "  hempora-cli [options] help <command>      " + _("Get help for a command") + "\n";
