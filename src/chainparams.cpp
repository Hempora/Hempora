...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000768524ad361e50e6d650e07369474f32df271626966533e0a069570085d"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1552878969, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("04ea1cedf2445485a4642fe2f47b8acebbed33bc34e581612b5bf1462d2587742991f5ce44471e7ab6053cfd17d0db85c27f861d77c117c31b183c69e93938f76d");
        nDefaultPort = 27878;
        ...
        const char* pszTimestamp = "Life is 10% what happens to you and 90% how you react to it - Hempora";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("040d6874aa2b3614e149a3fac02a6323fa0c9ba97dd6fe5d7b78c6bb1baa4ce387e4c954f128583c4bdb61d3e9ba3278988dafb563dfa0171410c3eb5493397664") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1552878969;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 1513774;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000768524ad361e50e6d650e07369474f32df271626966533e0a069570085d"));
        assert(genesis.hashMerkleRoot == uint256("0xc52113fea9c7ede7833cff7550c4e845aad8f63f3644a00428d13554d388a587"));

	vSeeds.push_back(CDNSSeedData("199.247.2.30", "199.247.2.30"));
        vSeeds.push_back(CDNSSeedData("199.247.12.86", "199.247.12.86"));
        vSeeds.push_back(CDNSSeedData("45.76.135.172", "45.76.135.172"));
	...
	strSporkKey = "0497A4B0EC419D440FAC4C32ED10D67F07C4A264647CD878A63101D3A8088A2F31D7624F67DC1E21B3AA0D2DB5D29CC7AA5396983E0B6D5841B97873DA90692E16";
        strObfuscationPoolDummyAddress = "H6e9P4nUqypJWqd7iU4b9rkEaXVDtTtkF1";
        nStartMasternodePayments = 1552878969;
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Hempora: 1 day
        nTargetSpacing = 1 * 60;  // Hempora: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet hempora addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet hempora script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet hempora BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet hempora BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet hempora BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Hempora: 1 day
        nTargetSpacing = 1 * 60;        // Hempora: 1 minutes
